...
public class KafkaPriceReadTest extends ExerciseBase {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaPriceReadTest.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        //pipeline.execute();
        var orderStream = env.addSource(pipeline.readPriceFromKafka(IN_PRICE,new PriceDeserializationSchema()))
