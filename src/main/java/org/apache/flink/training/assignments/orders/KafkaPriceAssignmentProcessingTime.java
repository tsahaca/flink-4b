...
public class KafkaPriceAssignmentProcessingTime extends ExerciseBase {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaPriceAssignmentProcessingTime.class);
